        ...
        <div class="cards">
            <div class="card" id="produk-card">
                ...
                <?php
                    ...
                    $hasil = mysqli_query($k,"SELECT COUNT(nama_barang) AS total_produk FROM tbl_barang GROUP BY nama_barang");
            ...
            <div class="card" id="pendapatan-card">
                ...
                <?php
                    ...
                    echo "<p id='total-pendapatan'>Rp$totalPendapatan</p>";
                ?>
            </div>
